...
public class formCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try {
            ...
            mascaraNascimento.setPlaceholder("_");
    ...
    private void btnEscolherFotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEscolherFotoActionPerformed
        JFileChooser file = new JFileChooser("C:\\Users\\rm74007\\Desktop\\Projeto_Banco_De_Dados_2SIA\\Fotos");
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        String endereceo = txtEndereco.getText();        
        String fone = txtFone.getText();
        
        SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
                
        try {
            Date nascimento = new Date(format.parse(txtNascimento.getText()).getTime());
            
            Cliente cliente = new Cliente(nome, endereceo, nascimento, fone, caminho);
            
            ClienteDAO dao = new ClienteDAO();
            dao.setCliente(cliente);
        }
        catch (ParseException e) {
            JOptionPane.showMessageDialog(null, "Erro ao gerar data de nascimento\n"+e);
        }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        ClienteDAO dao = new ClienteDAO();
        Cliente cliente = dao.getCliente(nome);
